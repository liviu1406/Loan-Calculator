...
def n_monthly_payments():
    loan_principal = args.principal  # int(input("Enter the loan principal:\n"))
    monthly_payment = args.payment  # float(input("Enter the monthly payment:\n"))
    loan_interest = args.interest / 1200  # float(input("Enter the loan interest:\n")) / 1200
...
def monthly_payment():
    loan_principal = args.principal  # int(input("Enter the loan principal:\n"))
    months = args.periods  # int(input("Enter the number of periods:\n"))
    loan_interest = args.interest / 1200  # float(input("Enter the loan interest:\n")) / 1200
    monthly_payment = loan_principal * (
                (loan_interest * ((1 + loan_interest) ** months)) / (((1 + loan_interest) ** months) - 1))
    total = 0
    if loan_principal < 0 or months < 0 or loan_interest < 0:
        print("Incorrect parameters")
        exit()
    else:
...
def loan_principal():
    monthly_payment = args.payment  # float(input("Enter the annuity payment:\n"))
    months = args.periods  # int(input("Enter the number of periods:\n"))
    loan_interest = args.interest / 1200  # float(input("Enter the loan interest:\n")) / 1200
    if monthly_payment < 0 or months < 0 or loan_interest < 0:
        print("Incorrect parameters")
        exit()
    else:
...
def differentiated_payment():
    loan_principal = args.principal  # int(input("Enter the loan principal:\n"))
    number_of_payments = args.periods  # int(input("Enter the number of payments:\n"))
    loan_interest = args.interest / 1200  # float(input("Enter the loan interest:\n")) / 1200
    total = 0
    if loan_principal < 0 or number_of_payments < 0 or loan_interest < 0:
        print("Incorrect parameters")
        exit()
    else:
...
# uncomment this piece if not using the terminal select your type of calculation
...
# comment this piece if not using the terminal
if args.interest is None:
    print("Incorrect parameters")
elif args.type is None:
    print("Incorrect parameters")
elif args.type == 'annuity' and args.principal is None and args.periods is not None and args.interest is not None:
    print(loan_principal())
